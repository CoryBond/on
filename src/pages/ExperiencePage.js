    ...
    <div className="mdl-grid portfolio-max-width">
      <div className="mdl-cell mdl-card mdl-shadow--4dp experience-card">
        ...
        <div className="mdl-card__supporting-text">
          ...
          and e-trading platform for ICG clients. Have and am continuing to add
          new business logic and features for our code base as well as actively
          handling team prod issues and releases.
          <br />
          Doing development with software tools <strong>JS</strong>,{" "}
      ...
      <div className="mdl-cell mdl-card mdl-shadow--4dp experience-card">
        ...
        <div className="mdl-card__supporting-text">
          ...
          Developed and managed several components to the server system to
          better enhance its functionalities and to add new ones. Designed and
          built several projects for the team that improved debugging and
          reporting of software bugs, networking and latency issues.
          <br />
      ...
      <div className="mdl-cell mdl-card mdl-shadow--4dp experience-card">
        ...
        <div className="mdl-card__supporting-text">
          ASPEN, an asset servicing platform. Worked mostly on platform code
          across several Hessian based components to replace legacy systems.
          <br />
          Developed with software tools <strong>Java</strong>,{" "}
          <strong>Hessian</strong>, <strong>Maven</strong>, <strong>GWT</strong>{" "}
          and <strong>Drools</strong>.
        </div>
      </div>
    </div>
  </s.ParticleBackgroundExperiences>
