          ...
          <div className="mdl-cell mdl-cell--12-col mdl-card mdl-shadow--4dp">
            ...
            <div className="mdl-card__media">
              <img
                ...
                src={`${loc.Images}vintage_telephone.jpg`}
                alt=""
              />
            </div>
            <div className="mdl-card__supporting-text">
              <br />
              <p>
                To quickly shoot me a message you may provide provide your name,
                a contact email, and your message below. This will be sent to my
                email directly. If you wish to contact me in another manner, or
                if your message is a bit long, then you can contact via:
              </p>
              <br />
